...
import com.google.samples.apps.iosched.provider.ScheduleContract.Partners;
...
//            context.sendBroadcast(ScheduleWidgetProvider.getRefreshBroadcastIntent(context, false));
     ...
     * parent {@link com.google.samples.apps.iosched.provider.ScheduleDatabase.Tables}. Used when needed to work around SQL ambiguity.
     */
